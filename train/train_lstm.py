"""
BiLSTM hate-speech classifier (HASOC 2019 English + Hindi, task_1: HOF/NOT)
Uses:
  - Character + word vocabulary built from training data
  - Embedding → BiLSTM → Attention pooling → FC → sigmoid
  - Class-weighted loss for imbalance
  - Saves model/lstm_model.pt + model/lstm_vocab.pkl

Run:
    conda run -n test python train/train_lstm.py
"""
