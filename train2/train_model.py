...
Outputs:
    model2/lr/model.pkl        (full Pipeline: FeatureUnion → LogisticRegression)
    model2/lr/vectorizer.pkl   (FeatureUnion only, kept for backward compatibility)
    model2/lr/report.json
    model2/plots/lr_*.png
"""
