"""
Evaluate the saved MuRIL checkpoint (model2/muril/) and regenerate:
...
MURIL_DIR   = os.path.join(BASE_DIR, "model2", "muril")
PLOTS_DIR   = os.path.join(BASE_DIR, "model2", "plots")
